...
function CountryCard({ code, isActive, lang }: { code: string; isActive: boolean; lang: string }) {
  ...
  return (
    <button
      ...
      className={`relative flex flex-col items-center gap-1 p-2.5 rounded-2xl border transition-all duration-200 min-w-[66px] w-[66px] sm:w-auto sm:min-w-0 group ${
        isActive
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-x-12 gap-y-14 mb-24">
          <div className="md:col-span-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                <span className={`text-[11px] ${L ? "tracking-normal" : "tracking-[3px]"} uppercase text-black/30 dark:text-white/30 font-medium flex items-center gap-1`}>🏙️ {L ? "الرياض" : "Riyadh"}</span>
                <span className="w-1 h-1 rounded-full bg-black/10 dark:bg-white/10" />
                <span className={`text-[11px] ${L ? "tracking-normal" : "tracking-[3px]"} uppercase text-black/30 dark:text-white/30 font-medium flex items-center gap-1`}>🏙️ {L ? "القاهرة" : "Cairo"}</span>
              </div>
            </div>
          </div>

          <div className="md:col-span-2 md:col-start-7">
            <h4 className={`text-[11px] font-semibold text-black/40 dark:text-white/40 uppercase ${L ? "tracking-normal" : "tracking-[3px]"} mb-7`}>{t("footer.quickLinks")}</h4>
            <ul className="space-y-4">
              {[
                ...
                { href: "/support",  label: L ? "الدعم الفني" : "Support" },
              ].map(link => (
                <li key={link.href}>
          ...
          <div className="md:col-span-2">
            <h4 className={`text-[11px] font-semibold text-black/40 dark:text-white/40 uppercase ${L ? "tracking-normal" : "tracking-[3px]"} mb-7`}>{t("nav.contact")}</h4>
            <ul className="space-y-4">
              {[
                { href: "/contact", label: t("nav.contact") },
          ...
          <div className="md:col-span-2">
            <h4 className={`text-[11px] font-semibold text-black/40 dark:text-white/40 uppercase ${L ? "tracking-normal" : "tracking-[3px]"} mb-7`}>{t("footer.legal")}</h4>
            <ul className="space-y-4">
              {[
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
              <p className={`text-[11px] ${L ? "tracking-normal" : "tracking-[2px]"} uppercase text-black/50 dark:text-white/50 font-bold`}>
