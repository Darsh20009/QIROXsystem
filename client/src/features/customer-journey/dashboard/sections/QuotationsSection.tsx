...
interface QuotationsSectionProps { lang?: "ar" | "en"; isLoading?: boolean; }

export function QuotationsSection({ lang = "ar", isLoading = false }: QuotationsSectionProps) {
  const isAr = lang === "ar";
  return (
