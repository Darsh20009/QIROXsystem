...
interface NotificationsSectionProps { lang?: "ar" | "en"; isLoading?: boolean; }

export function NotificationsSection({ lang = "ar", isLoading = false }: NotificationsSectionProps) {
  const isAr = lang === "ar";
  return (
    <section dir={isAr ? "rtl" : "ltr"}>
      ...
      <div className="rounded-xl border border-black/[0.06] dark:border-white/[0.06] overflow-hidden">
        {isLoading
          ...
          : EMPTY_STATES.notifications(lang)
        }
      </div>
    </section>
  );
