...
export default function GroupChat() {
  ...
  const deleteMsg = useMutation({
    ...
    onError: () => toast({ title: L ? "فشل حذف الرسالة" : "Delete failed", variant: "destructive" }),
  });
  ...
  const addMembers = useMutation({
    ...
    onError: (e: any) => toast({ title: L ? "فشل إضافة الأعضاء" : "Add members failed", description: e?.message, variant: "destructive" }),
  });
  ...
  const removeMember = useMutation({
    ...
    onError: () => toast({ title: L ? "فشل الإزالة" : "Remove failed", variant: "destructive" }),
  });
  ...
  const promoteAdmin = useMutation({
    ...
    onError: () => toast({ title: L ? "فشل تغيير الصلاحية" : "Permission change failed", variant: "destructive" }),
  });
  ...
  const leaveGroup = useMutation({
    ...
    onError: () => toast({ title: L ? "فشل مغادرة المجموعة" : "Leave failed", variant: "destructive" }),
  });
  ...
  const deleteGroup = useMutation({
    ...
    onError: () => toast({ title: L ? "فشل حذف المجموعة" : "Delete failed", variant: "destructive" }),
  });
