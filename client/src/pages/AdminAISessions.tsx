    ...
    <div className="space-y-6" dir={L ? "rtl" : "ltr"}>
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center overflow-hidden">
            <img src="/qirox-icon-nobg.png" alt="QIROX" className="w-7 h-7 object-contain dark:invert" />
          </div>
          <div>
