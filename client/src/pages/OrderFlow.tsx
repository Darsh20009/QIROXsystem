    ...
    <div className="min-h-screen bg-[#fafafa] dark:bg-gray-950" dir={dir}>
      ...
      <div className="max-w-xl mx-auto pt-20 px-4 pb-24">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
          <Button className="gap-2 rounded-xl bg-black dark:bg-white text-white dark:text-black hover:opacity-80" onClick={() => setLocation("/dashboard")} data-testid="button-go-dashboard">
            <ArrowLeft className="w-4 h-4" /> الذهاب للوحة التحكم ومتابعة مشروعي
          </Button>
        </div>
      </div>
      <Footer />
