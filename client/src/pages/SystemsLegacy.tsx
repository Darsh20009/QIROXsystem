...
export default function SystemsLegacy() {
  ...
  useSEO({
    ...
    keywords: "أنظمة كيروكس, نظام إدارة مطاعم, متجر إلكتروني سعودي, نظام تعليمي, Qirox systems, نظام ERP السعودية, نظام إدارة أعمال, برنامج محاسبة سعودي, نظام POS, نظام حجوزات, تطبيق مطعم, نظام مدرسة, نظام عيادة, نظام عقارات, كيروكس استوديو الرياض",
    canonical: "/systems",
    ogType: "website",
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "ItemList",
      "name": lang === "ar" ? "أنظمة كيروكس الرقمية" : "Qirox Digital Systems",
      "description": lang === "ar" ? "حلول برمجية متخصصة لكل قطاع" : "Specialized software solutions for every sector",
      "url": "https://qiroxstudio.online/systems",
      "numberOfItems": 8,
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "نظام إدارة مطاعم ومقاهي", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 2, "name": "نظام متجر إلكتروني", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 3, "name": "منصة تعليمية", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 4, "name": "نظام شركات ومؤسسات", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 5, "name": "نظام عقارات", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 6, "name": "نظام خدمات صحية", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 7, "name": "نظام خدمات منزلية", "url": "https://qiroxstudio.online/systems" },
        { "@type": "ListItem", "position": 8, "name": "نظام مستشفيات وعيادات", "url": "https://qiroxstudio.online/systems" },
      ]
    }
  });
