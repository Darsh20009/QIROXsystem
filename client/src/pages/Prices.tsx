...
export default function Prices() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#05050c]" dir="rtl">
      ...
      {/* ── Sector Tabs (scrollable on mobile, wrapped on desktop) ── */}
      <section className="px-4 pb-6">
        <div className="max-w-6xl mx-auto">
          <div
            className="flex md:flex-wrap md:justify-center gap-2 p-2 bg-black/[0.04] dark:bg-white/[0.04] rounded-2xl overflow-x-auto md:overflow-visible scrollbar-hide"
            ...
            {SECTORS_DATA.map(s => {
              ...
              return (
                <button
                  ...
                  className={`flex-shrink-0 flex flex-col items-center gap-1.5 py-2.5 px-3 min-w-[92px] rounded-xl transition-all ${active ? "bg-white dark:bg-[#1a1a2e] shadow-md" : "hover:bg-white/50 dark:hover:bg-white/[0.04]"}`}
                ...
                >
                  ...
                  <span className={`text-[10.5px] font-black whitespace-nowrap ${active ? "text-black dark:text-white" : "text-black/35 dark:text-white/35"}`}>{s.ar}</span>
                </button>
              );
            })}
          </div>
