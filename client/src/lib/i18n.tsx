...
const translations = {
  ...
  "order.docsNote": { ar: "يمكنك رفع روابط المستندات هنا (أو تركها فارغة للمناقشة لاحقاً)", en: "You can upload document links here (or leave empty to discuss later)" },
  ...
  "order.filePlaceholder": { ar: "رابط الملف...", en: "File link..." },
  ...
  "order.receiptLink": { ar: "رابط إيصال التحويل", en: "Transfer Receipt Link" },
  "order.receiptPlaceholder": { ar: "رابط صورة الإيصال...", en: "Receipt image link..." },
