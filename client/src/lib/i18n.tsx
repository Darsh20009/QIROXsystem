...
const translations = {
  ...
  "dsv2.nav.home":       { ar: "الرئيسية",      en: "Home" },
  "dsv2.nav.about":      { ar: "من نحن",        en: "About" },
  "dsv2.nav.plans":      { ar: "الباقات",       en: "Plans" },
  "dsv2.nav.devices":    { ar: "الأجهزة",       en: "Devices" },
  "dsv2.nav.consulting": { ar: "الاستشارات",    en: "Consulting" },
  "dsv2.nav.contact":    { ar: "تواصل معنا",    en: "Contact" },
  ...
  "dsv2.nav.startProject": { ar: "ابدأ مشروعك", en: "Start Your Project" },

  "dsv2.stats.projects":     { ar: "مشروع",           en: "Projects" },
  "dsv2.stats.satisfaction": { ar: "رضا العملاء",     en: "Client Satisfaction" },
  "dsv2.stats.years":        { ar: "سنوات خبرة",      en: "Years" },
  "dsv2.stats.countries":    { ar: "دولة",            en: "Countries" },
