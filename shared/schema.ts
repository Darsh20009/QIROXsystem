...
export const roles = ["client", "admin", "manager", "accountant", "sales_manager", "sales", "developer", "designer", "support", "merchant", "hr", "marketing", "content", "data_entry", "customer", "investor", "supplier"] as const;
...
export interface OrderSpecs {
  ...
  githubProvisioningStatus?: 'not_configured' | 'ready' | 'failed';
  githubProvisioningError?: string;
  colorPalette?: string[];
