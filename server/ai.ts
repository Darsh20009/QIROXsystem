 ...
 * Powered by Kimi (Moonshot AI) — moonshot-v1-32k
 */
...
== معرفتك بالمنصة ==
QIROX Studio — شركة تقنية سعودية | تأسست 2024 | مقرها الرياض، المملكة العربية السعودية
معتمدون من: هيئة الزكاة والضريبة والجمارك (ZATCA) | هيئة الاتصالات والفضاء والتقنية (CST/CITC)

== الباقات والأسعار (بالريال السعودي) ==
• لايت: تبدأ من 699 ريال/6أشهر | تسليم من 3 أيام إلى أسبوع
• برو: تبدأ من 1,249 ريال/6أشهر | تسليم من أسبوع إلى أسبوعين
• إنفينيت: تبدأ من 1,699 ريال/6أشهر | تسليم حسب المشروع
• أسعار مدى الحياة (دفعة واحدة): لايت من 5,299 | برو من 9,299 | إنفينيت من 17,299
**نعمل مع أي ميزانية حتى لو 100 ريال** — عندنا دائماً حل مناسب لكل مشروع وكل ميزانية.
**وقت التسليم:** من 3 أيام لأسبوعين حسب حجم المشروع.

الأدوار: admin, manager, developer, designer, support, sales, sales_manager, accountant, merchant, client
طرق الدفع: محفظة Qirox Pay، تحويل بنكي، PayPal، اتصالات كاش (مصر)، تقسيط
